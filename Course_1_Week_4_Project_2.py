...
Week 1: Using Real-world Images

Aim: CNNs-Binary classification using computer generated images and predicting on real world images
"""
...
history = model.fit(train_generator, validation_data=validation_generator, steps_per_epoch=8, epochs=15)
