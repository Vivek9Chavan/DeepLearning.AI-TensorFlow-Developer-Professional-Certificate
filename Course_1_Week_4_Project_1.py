...
Aim: Binary classification using computer generated images and predicting on real world images
"""
...
history = model.fit(train_generator, steps_per_epoch=8, epochs=1)

model.save("Saved_models/1_4_1_model.h5")
